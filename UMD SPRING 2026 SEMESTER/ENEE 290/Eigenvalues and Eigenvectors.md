...
Once the eigenvalues $\lambda_i, i = 1, ..., n$ are found, then the equation $(A - \lambda_i I) v_i = 0$ can be solved to find all eigenvectors $v_i$ corresponding to each eigenvalue.